...
### Dashboard File
My final dashboard is in [Project - Salary Dashboard.xlsx](Project%20-%20Salary%20Dashboard.xlsx).
...
- 📊 **Array Formula:** Utilises `MEDIAN()` function with nested `IF()` statement to analyse an array.
